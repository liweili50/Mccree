          ...
          <nav className="navbar">
            ...
            <div id="navbarExampleTransparentExample" className={`navbar-menu  ${isCollapse ? 'is-active' : ''}`} >
              ...
              <div className="navbar-end">
                <a className="navbar-item" target="_blank" href="https://www.zhihu.com/people/li-wei-Jonas/activities"><i className="czs-zhihu"></i></a>
                <a className="navbar-item" target="_blank" href="https://github.com/liweili50"><i className="czs-github-logo"></i></a>
              </div>
            </div>
          </nav>
        </div>
